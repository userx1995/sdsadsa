...
export class SuperAdminGuard implements CanActivate, CanActivateChild {
    ...
    canActivate(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<boolean> | Promise<boolean> | boolean {
        ...
        return filteredToken[0] == Role.superAdmin || filteredToken[0] == Role.operationManager ? true : this._router.navigateByUrl('/chat');
    }
    ...
    canActivateChild(childRoute: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree {
        ...
        return filteredToken == Role.superAdmin || filteredToken == Role.operationManager ? true : this._router.navigateByUrl('/home');
    }
